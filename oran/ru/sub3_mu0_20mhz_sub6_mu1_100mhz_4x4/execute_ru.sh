...
source /etc/profile
cd $work_path;source ../../oranenv.sh; cd $FLEXRAN_L1_SW/bin/nr5g/gnb/l1/orancfg/sub3_mu0_20mhz_sub6_mu1_100mhz_4x4/oru/;sh ./run_o_ru.sh  |tee $work_path/samppe.log &

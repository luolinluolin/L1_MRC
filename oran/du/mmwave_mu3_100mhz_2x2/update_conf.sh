...
phy_path=$FLEXRAN_L1_SW/bin/nr5g/gnb/l1/orancfg/mmwave_mu3_100mhz_2x2/gnb/
testmac_path=$FLEXRAN_L1_SW/bin/nr5g/gnb/testmac/
dpdk_path=$FLEXRAN_L1_SW/bin/nr5g/gnb/l1/
####################################
cd $base
cp $phy_path/testmac_clxsp_mu3_100mhz_hton_oru.cfg $testmac_path/
######### 
##########l1.sh
...
####################################
##
sed -i "s#.*phystart.*#$mac0#"     $testmac_path/testmac_clxsp_mu3_100mhz_hton_oru.cfg
#sed -i "s#\(setcore \)\S*#$mac1#"  $testmac_path/testmac_clxsp_mu3_100mhz_hton_oru.cfg

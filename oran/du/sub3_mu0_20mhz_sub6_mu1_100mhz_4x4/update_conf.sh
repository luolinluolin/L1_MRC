...
phy_path=$FLEXRAN_L1_SW/bin/nr5g/gnb/l1/orancfg/sub3_mu0_20mhz_sub6_mu1_100mhz_4x4/gnb/
testmac_path=$FLEXRAN_L1_SW/bin/nr5g/gnb/testmac/
dpdk_path=$FLEXRAN_L1_SW/bin/nr5g/gnb/l1/
####################################
cd $base
cp $phy_path/testmac_clxsp_multi_numerology_oru.cfg $testmac_path/testmac_clxsp_multi_numerology_oru.cfg6
######### 
##########l1.sh
...
####################################
##
sed -i "s#.*phystart.*#$mac0#"     $testmac_path/testmac_clxsp_multi_numerology_oru.cfg6
# sed -i "s#\(setcore \)\S*#$mac1#"  $testmac_path/testmac_clxsp_multi_numerology_oru.cfg6
